  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        subtle: "0 1px 4px oklch(0 0 0 / 0.12)",
      ...
      keyframes: {
        ...
        "timeline-dot-pulse": {
          "0%, 100%": { boxShadow: "0 0 0 0 oklch(0.45 0.18 240 / 0.4)" },
          "50%": { boxShadow: "0 0 0 12px oklch(0.45 0.18 240 / 0)" },
        },
        "star-pop": {
      ...
      animation: {
        ...
        "timeline-dot-pulse": "timeline-dot-pulse 2s ease-in-out infinite",
